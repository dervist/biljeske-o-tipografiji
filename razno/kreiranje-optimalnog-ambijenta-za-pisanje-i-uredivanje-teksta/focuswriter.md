...
[FocusWriter](https://gottcode.org/focuswriter/) je jedna od ovih aplikacija. Za temu ovog osvrta odabrao sam upravo ovu aplikaciju iz tri razloga:
...
3. objavljena je pod GPL3 licencom i svrstava se u [slobodni](https://bs.wikipedia.org/wiki/Slobodni\_softver) i [open-source](https://bs.wikipedia.org/wiki/Softver\_otvorenog\_koda) softver.
...
![Sesije omogućavaju grupisanje dokumenata koji pripadaju zajedničkom projektu ili čine logičku cjelinu](<../../.gitbook/assets/FocusWriter-Sessions (1).png>)
